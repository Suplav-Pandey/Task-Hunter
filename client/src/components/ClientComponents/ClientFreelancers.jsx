        ...
        <div className="container">
          <div className="section">
            ...
            <div className="services">
              {allServices && allServices.length != 0 ? allServices.map(service => <div key={service._id} className="service">
                ...
                <div className="serviceBody">
                  ...
                  <div className="rating-more">
                    ...
                    <HashLink to={`/dashboard/client/${id}/helpers/show/${service._id}`}> <button>See More</button></HashLink>
                  </div>
                </div>
                <hr />
              ...
              </div>) : <div className='noServices'>No Helper available for the moment</div>}
            </div>
          </div>
          <ClientMenu active="helpers" />
        </div>
      </div>
    </>
