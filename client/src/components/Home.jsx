    ...
    return (
        <div className='Home'>
            <div className="container">
                ...
                <section>
                    <div className="services" id='jobs'>
                        <div className="custom-headline">
                            Jobs
                        </div>
                        <div className="service">
                            <div className="service-headline">Plumbing</div>
                            <div className="service-description">
                                <div data-aos="fade-right" >
                                    <img src={webDeveloperService} alt="Plumbing" />

                                </div>
                                <div className="service-info" data-aos="fade-up">
                                    Need a leaky faucet fixed or a new toilet installed? Our skilled plumbers are ready to tackle any job, big or small.
                                </div>
                            </div>
                        </div>
                        <div className="service">
                            <div className="service-headline">Cleaning</div>
                            <div className="service-description reverse">
                                <div data-aos="fade-up">
                                    <img src={webDesignService} alt="Cleaning" />
                                </div>
                                <div className="service-info" data-aos="fade-right">
                                    We offer professional cleaning services to help businesses and individuals keep their spaces sparkling clean.
                                </div>
                            </div>
                        </div>
                        <div className="service">
                            <div className="service-headline">Moving</div>
                            <div className="service-description">
                                <div data-aos="fade-right">
                                    <img src={mobileService} alt="Moving" />
                                </div>
                                <div className="service-info" data-aos="fade-up">
                                    If you're in need of help moving, our strong and reliable movers have the skills and expertise to make it happen.
                                </div>
                            </div>
                        </div>
                    </div>
