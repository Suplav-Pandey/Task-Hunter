...
export default function Nav() {
    ...
    const handleProfile = () => {
        ...
        if (localStorage.getItem('userInfo')) {
            ...
            } else if (userInfo.role == "freelancer" || userInfo.role == "helper") {
                navigate(`/dashboard/helper/${userInfo._id}`)
            }
        }
    }
    const handleLogOut = () => {
    ...
    return (
        <div className='Nav'>
            <div className="container">
                <header>
                    <div className="logo">
                        <HashLink to="/#">Task Hunter</HashLink>
                    </div>
                    <nav>
                        <span className='menu-logo'>Task Hunter</span>
                        <HashLink to="/#">Home</HashLink>
                        <HashLink to="/#jobs" smooth>Jobs</HashLink>
