...
import FreelancerMenu from './HelperComponents/FreelancerMenu';
                                            ...
                                            {type == 1 ?
                                                ...
                                                <>
                                                    <div className="bottom-buttons">
                                                        <HashLink className="go-back-button" to={`/dashboard/client/${id}/helpers`}><button>Go Back</button></HashLink>
